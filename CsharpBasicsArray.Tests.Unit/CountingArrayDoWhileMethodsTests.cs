...
{
    [TestFixture]
    public sealed class CountingArrayCountingArrayDoWhileMethodsTests
    {
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayDoWhileMethods.GetFalseValueCount(null));
        }
        ...
        {
            // Act
            return CountingArrayDoWhileMethods.GetFalseValueCount(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayDoWhileMethods.GetFalseValueCountRecursive(null));
        }
        ...
        {
            // Act
            return CountingArrayDoWhileMethods.GetFalseValueCountRecursive(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayDoWhileMethods.GetZeroDecimalCount(null));
        }
        ...
        {
            // Act
            int actualResult = CountingArrayDoWhileMethods.GetZeroDecimalCount(arrayToSearch);
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayDoWhileMethods.GetZeroDecimalCountRecursive(null));
        }
        ...
        {
            // Act
            int actualResult = CountingArrayDoWhileMethods.GetZeroDecimalCountRecursive(arrayToSearch);
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayDoWhileMethods.GetRoundedToEvenCount(null));
        }
        ...
        {
            // Act
            return CountingArrayDoWhileMethods.GetRoundedToEvenCount(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayDoWhileMethods.GetRoundedToEvenCountRecursive(null));
        }
        ...
        {
            // Act
            return CountingArrayDoWhileMethods.GetRoundedToEvenCountRecursive(arrayToSearch);
        }
    }
}
