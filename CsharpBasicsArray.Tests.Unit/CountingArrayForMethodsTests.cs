...
{
    [TestFixture]
    public sealed class CountingArrayForMethodsTests
    {
        [Test]
        public void GetNegativeIntegerCount_ArrayToSearchParameterIsNull_ThrowsArgumentNullException()
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayForMethods.GetNegativeIntegerCount(null));
        }
        ...
        {
            // Act
            return CountingArrayForMethods.GetNegativeIntegerCount(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayForMethods.GetNegativeIntegerCountRecursive(null));
        }
        ...
        {
            // Act
            return CountingArrayForMethods.GetNegativeIntegerCountRecursive(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayForMethods.GetEvenNumberCount(null));
        }
        ...
        {
            // Act
            return CountingArrayForMethods.GetEvenNumberCount(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayForMethods.GetEvenNumberCountRecursive(null));
        }
        ...
        {
            // Act
            return CountingArrayForMethods.GetEvenNumberCountRecursive(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayForMethods.GetByteWithBitsInHighNibbleCount(null));
        }
        ...
        {
            // Act
            return CountingArrayForMethods.GetByteWithBitsInHighNibbleCount(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayForMethods.GetByteWithBitsInHighNibbleCountRecursive(null));
        }
        ...
        {
            // Act
            return CountingArrayForMethods.GetByteWithBitsInHighNibbleCountRecursive(arrayToSearch);
        }
    }
}
