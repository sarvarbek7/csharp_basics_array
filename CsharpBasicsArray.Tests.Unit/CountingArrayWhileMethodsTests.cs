...
{
    [TestFixture]
    public sealed class CountingArrayWhileMethodsTests
    {
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayWhileMethods.GetEmptyStringCount(null));
        }
        ...
        {
            // Act
            int actualResult = CountingArrayWhileMethods.GetEmptyStringCount(arrayToSearch);
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayWhileMethods.GetEmptyStringCountRecursive(null));
        }
        ...
        {
            // Act
            int actualResult = CountingArrayWhileMethods.GetEmptyStringCountRecursive(arrayToSearch);
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayWhileMethods.GetMinOrMaxLongCount(null));
        }
        ...
        {
            // Act
            return CountingArrayWhileMethods.GetMinOrMaxLongCount(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayWhileMethods.GetMinOrMaxLongCountRecursive(null));
        }
        ...
        {
            // Act
            return CountingArrayWhileMethods.GetMinOrMaxLongCountRecursive(arrayToSearch);
        }
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayWhileMethods.GetNullObjectCount(null));
        }
        ...
        public void GetNullObjectCount_ParametersAreValid_ReturnsResult(object[] data)
        {
            ...
            // Act
            int actualResult = CountingArrayWhileMethods.GetNullObjectCount(arrayToSearch);
        ...
        {
            // Act
            Assert.Throws<ArgumentNullException>(() => CountingArrayWhileMethods.GetNullObjectCountRecursive(null));
        }
        ...
        public void GetNullObjectCountRecursive_ParametersAreValid_ReturnsResult(object[] data)
        {
            ...
            // Act
            int actualResult = CountingArrayWhileMethods.GetNullObjectCountRecursive(arrayToSearch);
